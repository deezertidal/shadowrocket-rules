...
[配置文件链接](https://whatshub.top/config/shadowrocket_basic.conf)   
[更多教程](https://whatshub.top/manual.html)
<br>
### :point_down:打开小火箭 点击配置 点击右上角+号  
![Image text](https://github.com/deezertidal/shadowrocket-rules/blob/main/IMG/1a.png)  

### :point_down:将[配置文件](https://whatshub.top/config/shadowrocket_basic.conf)的链接地址复制粘贴至输入框并点击下载  
